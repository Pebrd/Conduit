...
class DesktopOAuthHandler(
    ...
    override suspend fun authenticateSpotify(clientId: String, clientSecret: String?): OAuthTokens? {
        ...
        val scopes = "playlist-read-private playlist-read-collaborative playlist-modify-private playlist-modify-public user-library-read user-read-private user-read-email user-top-read user-read-recently-played"
