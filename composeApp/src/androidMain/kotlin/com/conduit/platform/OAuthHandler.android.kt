...
class AndroidOAuthHandler(
    ...
    override suspend fun authenticateSpotify(clientId: String, clientSecret: String?): OAuthTokens? {
        ...
        val uri = Uri.parse("https://accounts.spotify.com/authorize")
            ...
            .appendQueryParameter("scope", "playlist-read-private playlist-read-collaborative playlist-modify-private playlist-modify-public user-library-read user-read-private user-read-email user-top-read user-read-recently-played")
